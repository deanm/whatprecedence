...
b.right,b,h,a);c[3]=a.length;a.push(d);l();break;case "op_b_typecast":g();c=[null,null,null,null];d="binary operator typecast";r={type:"op_u",text:"(",desc:d,p:c};d={type:"op_u",text:")",desc:d,p:c};a.push(r);c[0]=a.length;f=K(e,"left",b.left,b,h,a);c[1]=a.length;a.push(d);c[2]=a.length;K(e,"typecast",b.right,b,h,a);c[3]=a.length;l();break;case "op_u":case "op_u_s":d=b.d+("op_u"===f?" prefix":" postfix")+" associative unary operator "+b.f;d={type:f,text:b.f,desc:d,p:[null,null]};g();"op_u"===f&&a.push(d);
d.p[0]=a.length;K(e,"op_u"===f?"right":"left",b.left,b,h,a);d.p[1]=a.length;"op_u_s"===f&&a.push(d);l();break;case "op_b":d=b.d+" associative binary operator "+b.f;g();c=f=" ";if("."===b.f||"->"===b.f)f=c="";","===b.f&&(f="");d={type:"op_b",text:f+b.f+c,desc:d,p:[null,null,null,null]};d.p[0]=a.length;K(e,"left",b.left,b,h,a);d.p[1]=a.length;a.push(d);d.p[2]=a.length;K(e,"right",b.right,b,h,a);d.p[3]=a.length;l();break;case "op_t":d="right associative ternary operator ?:";c=[null,null,null,null,null,
null];r={type:"op_t",text:" ? ",desc:d,p:c};d={type:"op_t",text:" : ",desc:d,p:c};g();c[0]=a.length;K(e,"left",b.left,b,h,a);c[1]=a.length;a.push(r);c[2]=a.length;K(e,"middle",b.m,b,h,a);c[3]=a.length;a.push(d);c[4]=a.length;K(e,"right",b.right,b,h,a);c[5]=a.length;l();break;default:throw"Internal error, unhandled node: "+b.a;}}
