...
var m=20;function n(){throw"error, invalid led call";}function p(){throw"error, invalid nud call";}function q(d,f,c,a){return{a:"op_b",g:d,c:f,b:a,h:0===f?n:function(c,b){this.e=f;this.left=c;this.right=b.d(f+("right"===a?0.1:0),b);return this},i:0===c?p:function(a){this.a="op_u";this.e=c;this.b="right";this.left=a.d(c,a);return this}}}function s(d,f,c){return q(d,f,c,"left")}function t(d,f,c){return{a:"num",n:d,left:f,r:c,h:n,i:function(){return this}}}
function u(d){return{a:"sym",left:d,h:n,i:function(){return this}}}function w(d,f){return t("int",d,f)}function x(d,f){return t("flt",d,f)}function A(d){return{a:"op_b_typecast",b:"right",h:n,i:function(f){this.left=u(d);this.right=f.d(3.1,f);return this}}}
function B(d){function f(){var g=d[a];if(a+1<k){var h=g+d[a+1];if(a+2<k){var l=h+d[a+2];switch(l){case "<<=":case ">>=":return a+=3,q(l,16,0,"right")}}switch(h){case "++":case "--":return a+=2,{a:"op_u",g:h,c:2,h:function(a){this.a+="_s";this.e=2;this.b="left";this.left=a;return this},i:function(a){this.b="right";this.e=3;this.left=a.d(3,a);return this}};case "->":return a+=2,s(h,2,0);case "<<":case ">>":return a+=2,s(h,7,0);case "<=":case ">=":return a+=2,s(h,8,0);case "==":case "!=":return a+=2,
...
c())&&"sym"===g.a&&(-1!==y.indexOf(g.left)||-1!==z.indexOf(g.left))){for(g=[];;)if(h=f(),null!==h){if(")"===h.a)break;if("sym"!==h.a||-1===y.indexOf(h.left)&&-1===z.indexOf(h.left))throw"Unexpected non-typey symbol in typecast: "+h.left;g.push(h.left)}return A(g.join(" "))}return{a:"_paren",c:2,h:function(a,b){var c=null;")"!==b.f().a&&(c=b.d(m,b));if(")"!==b.f().a)throw"Unmatched left parenthesis";b.advance();return{a:"fun",c:2,e:2,b:"left",left:a,right:c}},i:function(a){var b=a.d(m,a);if(")"!==
a.f().a)throw"Unmatched left parenthesis";a.advance();return b}};case "[":return++a,{a:"op_b[]",c:2,b:"left",h:function(a,b){this.e=2;var c=b.d(m,b);if("]"!==b.f().a)throw"Unmatched left bracket";b.advance();this.left=a;this.right=c;return this},i:p};case ":":return++a,{a:":"};case "?":return++a,{a:"op_t",g:"?:",b:"right",c:15,h:function(a,b){this.e=15;this.left=a;this.m=b.d(m-1,b);if(":"!==b.f().a)throw"Unmatched : for ?.";b.advance();this.right=b.d(m-1,b);return this},i:p};case "=":return++a,q(g,
...
function C(d){d={l:d,j:0,k:function(){return this.j>=this.l.length},f:function(){return this.k()?{c:m,type:"end"}:this.l[this.j]},advance:function(){++this.j},d:function(d,c){if(!c.k()){var a=c.f();c.advance();console.log("rprec: "+d+" exp: "+a.a);var k=a.i(c);console.log("  left: "+k.a);for(console.log("  lprec: "+c.f().c);d>c.f().c;)a=c.f(),c.advance(),console.log("    t: "+a.a),k=a.h(k,c),console.log("    left: "+k.a),console.log("    lprec: "+c.f().c);return k}}};return d.d(m-1,d)}
