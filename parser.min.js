...
a;this.g=c;return this},j:n};case ":":return++b,{a:":"};case "?":return++b,{a:"op_t",e:"?:",d:"right",l:15,i:function(a,b){this.c=15;this.b=a;this.o=b.f(19);if(":"!==b.k())throw"Unmatched : for ?.";this.g=b.f(19);return this},j:n}}throw"Failed in lexing input: "+e.substr(b);}function d(){for(var a=b;b<l;){var d=c();if(d!==y)return b=a,d}b=a;return null}var b=0,l=e.length;this.n=function(){for(;b<l;){var a=c();if(a!==y)return a}return null}}
