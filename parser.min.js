...
var m=20;function n(){throw"error, invalid led call";}function p(){throw"error, invalid nud call";}function r(d,f,c,a){return{a:"op_b",g:d,d:f,c:a,h:0===f?n:function(a,b){this.b=f;this.left=a;this.right=b.e(f,b);return this},i:0===c?p:function(a){this.a="op_u";this.b=c;this.c="right";this.left=a.e(c,a);return this}}}function s(d,f,c){return r(d,f,c,"left")}function t(d,f,c){return{a:"num",n:d,left:f,r:c,h:n,i:function(){return this}}}
function u(d){return{a:"sym",left:d,h:n,i:function(){return this}}}function w(d,f){return t("int",d,f)}function x(d,f){return t("flt",d,f)}function A(d){return{a:"op_b_typecast",c:"right",h:n,i:function(f){this.left=u(d);this.right=f.e(3.1,f);return this}}}
function B(d){function f(){var g=d[a];if(a+1<k){var h=g+d[a+1];if(a+2<k){var l=h+d[a+2];switch(l){case "<<=":case ">>=":return a+=3,r(l,16.1,0,"right")}}switch(h){case "++":case "--":return a+=2,{a:"op_u",g:h,d:2,h:function(a){this.a+="_s";this.b=2;this.c="left";this.left=a;return this},i:function(a){this.c="right";this.b=3;this.left=a.e(3,a);return this}};case "->":return a+=2,s(h,2,0);case "<<":case ">>":return a+=2,s(h,7,0);case "<=":case ">=":return a+=2,s(h,8,0);case "==":case "!=":return a+=
2,s(h,9,0);case "&&":return a+=2,s(h,13,0);case "||":return a+=2,s(h,14,0);case "+=":case "-=":case "*=":case "/=":case "%=":case "&=":case "^=":case "|=":return a+=2,s(h,16,0)}}switch(g){case ".":return++a,s(g,2,0);case "!":case "~":return++a,s(g,0,3);case "*":return++a,s(g,5,3);case "/":case "%":return++a,s(g,5,0);case "+":case "-":return++a,s(g,6,3);case "&":return++a,s(g,10,3);case "^":return++a,s(g,11,0);case "|":return++a,s(g,12,0);case ")":case "]":return++a,{a:g};case "(":++a;if((g=c())&&
"sym"===g.a&&(-1!==y.indexOf(g.left)||-1!==z.indexOf(g.left))){for(g=[];;)if(h=f(),null!==h){if(")"===h.a)break;if("sym"!==h.a||-1===y.indexOf(h.left)&&-1===z.indexOf(h.left))throw"Unexpected non-typey symbol in typecast: "+h.left;g.push(h.left)}return A(g.join(" "))}return{a:"_paren",d:2,h:function(a,b){var c=null;")"!==b.f().a&&(c=b.e(m,b));if(")"!==b.f().a)throw"Unmatched left parenthesis";b.advance();return{a:"fun",d:2,b:2,c:"left",left:a,right:c}},i:function(a){var b=a.e(m,a);if(")"!==a.f().a)throw"Unmatched left parenthesis";
a.advance();return b}};case "[":return++a,{a:"op_b[]",d:2,c:"left",h:function(a,b){this.b=2;var c=b.e(m,b);if("]"!==b.f().a)throw"Unmatched left bracket";b.advance();this.left=a;this.right=c;return this},i:p};case ":":return++a,{a:":"};case "?":return++a,{a:"op_t",g:"?:",c:"right",d:15,h:function(a,b){this.b=15;this.left=a;this.m=b.e(m-1,b);if(":"!==b.f().a)throw"Unmatched : for ?.";b.advance();this.right=b.e(m-1,b);return this},i:p};case "=":return++a,r(g,16.1,0,"right");case ",":return++a,r(g,18.1,
0,"right");case " ":case "\t":case "\r":case "\n":return++a,b}h=3;for(l=q.length;h<l;h+=4)if(g=q[h-3],null!==(g=d.slice(a).match(g))){var l=q[h-2],D=q[h],v="",h=(0,q[h-1])(g[0]);a+=g[0].length;null!==(g=d.slice(a).match(l))&&(v=g[0],a+=v.length);return D(h,v)}if(null!==(g=d.slice(a).match(e)))return g=g[0],a+=g.length,u(g);throw"Failed in processing input: "+d.slice(a);}function c(){for(var c=a;a<k;){var d=f();if(d!==b)return a=c,d}a=c;return null}var a=0,k=d.length,b={},e=/^[a-zA-Z_][a-zA-Z0-9_]*/,
l=/^[uU][lL]?|[uU](?:ll|LL)|[lL][uU]?|(?:ll|LL)[uU]?/,q=[/^(?:[0-9]*\.[0-9]+|[0-9]+\.)(?:[eE][+-]?[0-9]+)?|^[0-9]+[eE][+-]?[0-9]+/,/^[fFlL]/,parseFloat,x,/^0[xX][0-9a-fA-F]+/,l,function(a){return parseInt(a,16)},w,/^0[0-7]*/,l,function(a){return parseInt(a,8)},w,/^[1-9][0-9]*/,l,function(a){return parseInt(a,10)},w],y=["signed","unsigned","short","long"],z="bool;char;int;float;double;wchar_t;char16_t;char32_t;_Bool;float_t;double_t;int8_t, uint8_t;int16_t, uint16_t;int32_t, uint32_t;int64_t, uint64_t;intptr_t, uintptr_t;size_t;ssize_t;ptrdiff_t".split(";");
