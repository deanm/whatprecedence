...
var m=20;function n(){throw"error, invalid led call";}function p(){throw"error, invalid nud call";}function q(d,f,c,a){return{a:"op_b",g:d,d:f,c:a,h:0===f?n:function(c,b){this.b=f;this.left=c;this.right=b.e(f+("right"===a?0.1:0),b);return this},i:0===c?p:function(a){this.a="op_u";this.b=c;this.c="right";this.left=a.e(c,a);return this}}}function s(d,f,c){return q(d,f,c,"left")}function t(d,f,c){return{a:"num",n:d,left:f,r:c,h:n,i:function(){return this}}}
...
function B(d){function f(){var g=d[a];if(a+1<k){var h=g+d[a+1];if(a+2<k){var l=h+d[a+2];switch(l){case "<<=":case ">>=":return a+=3,q(l,16,0,"right")}}switch(h){case "++":case "--":return a+=2,{a:"op_u",g:h,d:2,h:function(a){this.a+="_s";this.b=2;this.c="left";this.left=a;return this},i:function(a){this.c="right";this.b=3;this.left=a.e(3,a);return this}};case "->":return a+=2,s(h,2,0);case "<<":case ">>":return a+=2,s(h,7,0);case "<=":case ">=":return a+=2,s(h,8,0);case "==":case "!=":return a+=2,
