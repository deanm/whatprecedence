...
var C={" ":B(),"\t":B(),"\r":B(),"\n":B(),"++":z(1),"--":z(2),".":x(2,0),"->":x(2,0),"!":y(0,3),"~":y(0,3),"*":x(5,3),"/":x(5,0),"%":x(5,0),"+":x(6,3),"-":x(6,3),"<<":x(7,0),">>":x(7,0),"<":x(8,0),"<=":x(8,0),">":x(8,0),">=":x(8,0),"==":x(9,0),"!=":x(9,0),"&":x(10,3),"^":x(11,0),"|":x(12,0),"&&":x(13,0),"||":x(14,0),"=":y(16,0),"+=":y(16,0),"-=":y(16,0),"*=":y(16,0),"/=":y(16,0),"%=":y(16,0),"<<=":y(16,0),">>=":y(16,0),"&=":y(16,0),"^=":y(16,0),"|=":y(16,0),",":x(18,0)},D=/^[uU](?:ll|LL)|^[uU][lL]?|^(?:ll|LL)[uU]?|^[lL][uU]?/,
...
function H(d){function c(){if(e>=l)throw"Unexpected end of input";for(var a,g=d.substr(e),h=3,f=E.length;h<f;h+=4)if(null!==(a=g.match(E[h-3]))){var m=E[h-2],f=E[h-1],h=E[h],g=a[0];e+=g.length;f=null!==f?f(g):g;if(null===m)return"sizeof"===f?r():-1!==F.indexOf(f)||-1!==G.indexOf(f)?u(f):h(f);var p="";null!==(a=d.substr(e).match(m))&&(p=a[0],e+=p.length);return h(f,p,g+p)}for(a=3;0<a;--a)if(e+a<=l&&(m=d.substr(e,a),h=C[m],void 0!==h))return e+=a,h(m);switch(m){case ")":case "]":case ":":return++e,
{a:m,i:n,j:k};case "(":++e;if((a=b())&&"typespec"===a.a){a=[];for(h=m=!1;;)if(g=c(),g!==A){if(")"===g.a)break;if("op_b"===g.a&&"*"===g.g){if(!1===h)throw"* in typecast before any type";a.push("*");m=!0}else if("typespec"===g.a&&-1!==F.indexOf(g.b)){if(!0===h)throw"Typecast qualifier after a type";if(!0===m)throw"Typecast qualifier after a *";a.push(g.b);seen_qualifier=!0}else if("typespec"===g.a&&-1!==G.indexOf(g.b)){if(!0===h)throw"Typecast type after another type";if(!0===m)throw"Typecast type after a *";
a.push(g.b);h=!0}else throw"Unexpected non-typey symbol in typecast: "+g.a;}return w(a.join(" "))}return{a:"_paren",l:2,i:function(a,b){var c=null,d={c:null},e=d;if(")"!==b.e.a)for(;;){c=b.h(18);c={a:"funarg",b:c,c:null};e=e.c=c;if("op_b"!==b.e.a||","!==b.e.g)break;b.k()}if(")"!==b.k())throw"Unmatched left parenthesis";return{a:"fun",l:2,d:2,f:"left",b:a,c:d.c}},j:function(a){if(")"===a.e.a)throw"Empty parentheses expression";var b=a.h(20);if(")"!==a.k())throw"Unmatched left parenthesis";return b}};
case "[":return++e,{a:"op_b[]",l:2,f:"left",i:function(a,b){this.d=2;if("]"===b.e.a)throw"Empty subscript";var c=b.h(20);if("]"!==b.k())throw"Unmatched left bracket";this.b=a;this.c=c;return this},j:k};case "?":return++e,{a:"op_t",g:"?:",f:"right",l:15,i:function(a,b){this.d=15;this.b=a;this.o=b.h(20);if(":"!==b.k())throw"Unmatched : for ?";this.c=b.h(15.1);return this},j:k}}throw"Failed in lexing input: "+d.substr(e);}function b(){for(var a=e;e<l;){var b=c();if(b!==A)return e=a,b}e=a;return null}
var e=0,l=d.length;this.n=function(){for(;e<l;){var a=c();if(a!==A)return a}return null}}function I(d){var c={l:20,a:"end"};this.e=c;this.m=function(){return this.e===c};this.k=function(){var b=this.e.a,e=d.n();this.e=null===e?c:e;return b};this.h=function(b){if(this.m())return null;var c=this.e;this.k();for(var d=c.j(this);b>this.e.l;)c=this.e,this.k(),d=c.i(d,this);return d};this.k()}function J(d){d=new I(d);var c=d.h(19);if(!d.m())throw"Trailing token: "+d.e.a;return c}
